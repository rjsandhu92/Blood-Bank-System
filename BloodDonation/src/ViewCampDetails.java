...
public class ViewCampDetails extends javax.swing.JFrame {

    public ViewCampDetails(int id) {
        initComponents();
        ...
        try
        {
            ...
            ResultSet rs = stmt.executeQuery("select camp_name,camp_blood_collection,camp_total_amount from camp where camp_id='"+id+"'");
            rs.next();
            String name = rs.getString("camp_name");
            viewCampDetailsNameText.setText(name);
    ...
    private void initComponents() {
        ...
        viewCampDetailsNameText.setText("Blood Bank");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCampDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ViewCampDetails(1).setVisible(true);
            }
        });
    }
